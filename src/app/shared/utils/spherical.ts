export class Spherical {
     ...
     */
    private static havDistance(lat1, lat2, dLng) {
     ...
     */
    private static distanceRadians(lat1, lng1, lat2, lng2) {
     ...
     * on the unit sphere.
     */
    private static computeAngleBetween(from, to) {
    ...
    public static computeDistanceBetween(from, to): number {
        return this.computeAngleBetween(from, to) * Spherical.EARTH_RADIUS;
    }
}